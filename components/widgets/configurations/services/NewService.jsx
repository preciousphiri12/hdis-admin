...
export default function NewService({ openService, setOpenService }) {
  const { serviceTypes } = useContext(ServiceTypeContext);

  return (
    <div className="">
      <Transition.Root show={openService} as={Fragment}>
        <Dialog as="div" className="relative z-10" onClose={setOpenService}>
          <Transition.Child
            as={Fragment}
                        ...
                        <div className="flex w-full mr-4">
                          ...
                          >
                            ...
                            {serviceTypes?.map((serviceType, key) => {
                              return (
                                <option key={key} value={serviceType?.uid}>
                                  {serviceType?.name}
                                </option>
                              );
                            })}
